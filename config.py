...
class Config(object):
    # Bot Information 
    TECH_VJ_BOT_TOKEN = os.environ.get("BOT_TOKEN", "")
    TECH_VJ_BOT_USERNAME = os.environ.get("BOT_USERNAME", "") # Bot username without @.
    
    # The Telegram API things
    TECH_VJ_API_ID = int(os.environ.get("API_ID", ""))
    TECH_VJ_API_HASH = os.environ.get("API_HASH", "")
    ...
    TECH_VJ_OWNER_ID = int(os.environ.get("OWNER_ID", "")) 
    TECH_VJ_SESSION_NAME = "VJ-URL-UPLOADER-BOT"
    
    # database uri (mongodb)
    TECH_VJ_DATABASE_URL = os.environ.get("DATABASE_URL", "")
    TECH_VJ_MAX_RESULTS = "50"

    # channel information
    TECH_VJ_LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1001757174395")) # your log channel id and make bot admin in log channel with full right 
    
    # if you want force subscribe then give your channel id below else leave blank
    tech_vj_update_channel = environ.get('VJ_UPDATES_CHANNEL', '-1002074469010') # your update channel id and make bot admin in update channel with full right
    ...
    TECH_VJ_API = environ.get('TECH_VJ_API', '39152fbbd3de6c3497fabae90ddd88b84bfea6d8') # your url shortner api
    TECH_VJ_TUTORIAL = os.environ.get("TECH_VJ_TUTORIAL", "https://t.me/openlinkogpinda")
